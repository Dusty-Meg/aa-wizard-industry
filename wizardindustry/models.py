...
class BasePrice(models.Model):
    ...
    Base Price Model
    """
    eve_type = models.OneToOneField(ItemType, on_delete=models.CASCADE, related_name="wizardindustry_base_price", default=None)
    base_price = models.DecimalField(max_digits=20, decimal_places=2, null=True, blank=True)


class invMetaTypes(models.Model):
    eve_type = models.OneToOneField(ItemType, on_delete=models.CASCADE, related_name="inv_meta_types", default=None)
